...
- Java基础核心串讲
  ...
  - 计算机操作系统与Linux
  - [学习linux命令，看这篇2w多字的命令详解就够了](https://mp.weixin.qq.com/s/7bSwKiPmtJbs7FtRWZZqpA) :heavy_check_mark:​
...
- 并发与多线程
  ...
  - [如果你这样回答“什么是线程安全”，面试官都会对你刮目相看（建议珍藏）](https://mp.weixin.qq.com/s/WDeewsvWUEBIuabvVVhweA):heavy_check_mark:
  - [乐观锁、悲观锁](https://mp.weixin.qq.com/s/WtAdXvaRuBZ-SXayIKu1mA):heavy_check_mark:
...
- 数据库
  ...
  - [数据库基础知识](https://mp.weixin.qq.com/s/NDL1Q6nqdPq5oMBWSpq4ug):heavy_check_mark:​
